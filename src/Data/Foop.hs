...
type MkSlot :: Type -> Type -> (Type -> Type) -> (Type -> Type) -> SlotData 
type MkSlot r i q m = '(r,i,q,m)
...
-- don't export 
type Object :: Type -> (Type -> Type) -> (Type -> Type) -> Type 
newtype Object r m q = Object (Entity r m q)
